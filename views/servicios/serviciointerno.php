            ...
            <div class="col-md-16 offset-md-0">
                <div class="card">
                    ...
                    <div class="card-body bg-light">
                        <form action="insertserviciointerno.php" method="POST">
                            <b>
                            ...
                            <div class="input-group">
                                <span class="input-group-text">V Nom Input (Vac)</span>
                                <input type="text" aria-label="First name" class="form-control" name="vninput_f1" placeholder="F1">
                                <input type="text" aria-label="Last name" class="form-control" name="vninput_f2" placeholder="F2">
                                <input type="text" aria-label="Last name" class="form-control" name="vninput_f3" placeholder="F3">
                                <input type="text" aria-label="Last name" class="form-control" name="vninput_com" placeholder="OBSERVACIONES">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">V Nom Output (Vac)</span>
                                <input type="text" aria-label="First name" class="form-control" name="vnoutput_f1" placeholder="F1">
                                <input type="text" aria-label="Last name" class="form-control" name="vnoutput_f2" placeholder="F2">
                                <input type="text" aria-label="Last name" class="form-control" name="vnoutput_f3" placeholder="F3">
                                <input type="text" aria-label="Last name" class="form-control" name="vnoutput_com" placeholder="OBSERVACIONES">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">I Nom Input (Aac)</span>
                                <input type="text" aria-label="First name" class="form-control" name="ininput_f1" placeholder="F1">
                                <input type="text" aria-label="Last name" class="form-control" name="ininput_f2" placeholder="F2">
                                <input type="text" aria-label="Last name" class="form-control" name="ininput_f3" placeholder="F3">
                                <input type="text" aria-label="Last name" class="form-control" name="ininput_com" placeholder="OBSERVACIONES">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">V Medido Entrada (Vac)</span>
                                <input type="text" aria-label="First name" class="form-control" name="vmentrada_f1" placeholder="F1">
                                <input type="text" aria-label="Last name" class="form-control" name="vmentrada_f2" placeholder="F2">
                                <input type="text" aria-label="Last name" class="form-control" name="vmentrada_f3" placeholder="F3">
                                <input type="text" aria-label="Last name" class="form-control" name="vmentrada_com" placeholder="OBSERVACIONES">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">V Medido Salida (Vac)</span>
                                <input type="text" aria-label="First name" class="form-control" name="vmsalida_f1" placeholder="F1">
                                <input type="text" aria-label="Last name" class="form-control" name="vmsalida_f2" placeholder="F2">
                                <input type="text" aria-label="Last name" class="form-control" name="vmsalida_f3" placeholder="F3">
                                <input type="text" aria-label="Last name" class="form-control" name="vmsalida_com" placeholder="OBSERVACIONES">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">Tipo de Baterías</span>
                                <input type="text" aria-label="First name" class="form-control" name="tipo_bateria" placeholder="Tipo de Baterías">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">Voltaje Baterías Vcd</span>
                                <input type="text" aria-label="First name" class="form-control" name="voltaje_bateria" placeholder="Voltaje Baterías Vcd">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">Cantidad de Baterías</span>
                                <input type="text" aria-label="First name" class="form-control" name="cantidad_baterias" placeholder="Cantidad de Baterías">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">Fecha de Baterías</span>
                                <input type="date" aria-label="First name" class="form-control" name="fecha_bateria" placeholder="Fecha de Baterías">
                            </div>
                            <br>
                            ...
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">Número de Baterías</span>
                                <input type="text" aria-label="First name" class="form-control"name="numerobateria_banco" placeholder="Número de Baterías">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">I Output (A)</span>
                                <input type="text" aria-label="First name" class="form-control" name="ioutput_banco" placeholder="I Output (A)">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">Fecha de Instalación de Baterías</span>
                                <input type="text" aria-label="First name" class="form-control" name="fechainstalacionbateria_banco" placeholder="Fecha de Instalación de Baterías">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">Equipo con Garantia: (Si No)</span>
                                <input type="text" aria-label="First name" class="form-control" name="garantia_banco" placeholder="Equipo con Garantia">
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-text">Tipo de Baterías</span>
                                <input type="text" aria-label="First name" class="form-control" name="tipobateria_banco" placeholder="Tipo de Baterías">
                            </div>
                            <br>
