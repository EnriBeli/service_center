...
$sql="INSERT INTO tbl_serviciosgenerales (folio, fecha, cliente, contacto, tel_ext, email, udn, temperatura, humedad, responsables_udn, ubicacion_equipo, aire_acondicionado,
            ...
            VALUES ('$folio', '$fecha', '$cliente', '$contacto', '$tel_ext', '$email', '$udn', '$temperatura', '$humedad', '$responsables_udn', '$ubicacion_equipo', '$aire_acondicionado', 
